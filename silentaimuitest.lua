...
local repo = "https://raw.githubusercontent.com/dhsunisahentai/Obsidian/main/"
...
local Window = Library:CreateWindow({ Title = "micetice.cc", Footer = "1.3", Center = true, AutoShow = true })
